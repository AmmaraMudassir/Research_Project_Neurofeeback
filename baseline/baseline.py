...
#firebase = firebase.FirebaseApplication("https://pythontojs.firebaseio.com/",None)
...
class CollectData:
    ...
    def data_acq(self):
        ...
        self.column_names=['Bands','Time','Channel 1','Channel 2','Channel 3','Channel 4','Channel 5','Channel 6','Channel 7','Channel 8','Channel 9','Channel 10','Channel 11','Channel 12','Channel 13','Channel 14'] 
        ...
        #while True:    
            ...
            if self.readytocollect==True:
                ...
                if self.nSamplesTaken[0] == 128:
                    ...
                    #h=np.fft.fft(y)
                    #f= map(lambda x: abs(x/128), h)
                    #f= map(lambda x:x[:128/2+1]*2,f)                  
                    pwelch = signal.welch(y, 128, window="hanning", nperseg=128, noverlap= 64, nfft =128)
                    f=pwelch[1]
                    #delta = map(lambda x: x[wL*1/Fs-1: wL*4/Fs],f) 
                    ...
                    print "Mean value of delta is " + str(delta_m)
                    print "Mean value of theta is " + str(theta_m)
                    print "Mean value of alpha is " + str(alpha_m)
                    print "Mean value of smr is " + str(smr_m)
                    print "Mean value of beta is " + str(beta_m)
                    print "Mean value of highbeta is " + str(highbeta_m)
                    print "Mean value of gamma is " + str(gamma_m)
                    ...
                    features_action_dict={
                        ...
                        'Channel 1':[delta_m[0],theta_m[0],alpha_m[0],smr_m[0],beta_m[0],highbeta_m[0],gamma_m[0]],
                        'Channel 2':[delta_m[1],theta_m[1],alpha_m[1],smr_m[1],beta_m[1],highbeta_m[1],gamma_m[1]],
                        'Channel 3':[delta_m[2],theta_m[2],alpha_m[2],smr_m[2],beta_m[2],highbeta_m[2],gamma_m[2]],
                        'Channel 4':[delta_m[3],theta_m[3],alpha_m[3],smr_m[3],beta_m[3],highbeta_m[3],gamma_m[3]],
                        'Channel 5':[delta_m[4],theta_m[4],alpha_m[4],smr_m[4],beta_m[4],highbeta_m[4],gamma_m[4]],
                        'Channel 6':[delta_m[5],theta_m[5],alpha_m[5],smr_m[5],beta_m[5],highbeta_m[5],gamma_m[5]],
                        'Channel 7':[delta_m[6],theta_m[6],alpha_m[6],smr_m[6],beta_m[6],highbeta_m[6],gamma_m[6]],
                        'Channel 8':[delta_m[7],theta_m[7],alpha_m[7],smr_m[7],beta_m[7],highbeta_m[7],gamma_m[7]],
                        'Channel 9':[delta_m[8],theta_m[8],alpha_m[8],smr_m[8],beta_m[8],highbeta_m[8],gamma_m[8]],
                        'Channel 10':[delta_m[9],theta_m[9],alpha_m[9],smr_m[9],beta_m[9],highbeta_m[9],gamma_m[9]],
                        'Channel 11':[delta_m[10],theta_m[10],alpha_m[10],smr_m[10],beta_m[10],highbeta_m[10],gamma_m[10]],
                        'Channel 12':[delta_m[11],theta_m[11],alpha_m[11],smr_m[11],beta_m[11],highbeta_m[11],gamma_m[11]],
                        'Channel 13':[delta_m[12],theta_m[12],alpha_m[12],smr_m[12],beta_m[12],highbeta_m[12],gamma_m[12]],
                        'Channel 14':[delta_m[13],theta_m[13],alpha_m[13],smr_m[13],beta_m[13],highbeta_m[13],gamma_m[13]]
                    ...
                    j+=1
                    store_action_Features.to_csv("baseline.csv")
