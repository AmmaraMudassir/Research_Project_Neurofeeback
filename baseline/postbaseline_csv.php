...
*/
	...
	//include login file to use the functions in there
...
*/
	...
	//name files for threshold and mean of data 
		$file = "../". $_SESSION["structure"]."/"."postbaseline.csv";
		$file1="../".$_SESSION["structure"]."/"."postbaselinemean.csv";
		$file2="../".$_SESSION["structure"]."/"."rawdatapost.csv";
	...
	header("Location: ../postBaseline.php");
?>