  ...
  if (!isset($_GET["app"])) {
    ...
    <form class="fluid-container d-flex flex-column align-items-center justify-content-center p-5 mt-4">
      <div class="builtin p-4 shadow rounded w-50">
        <h2 class="text-center mb-5">Test Report</h2>
        <div class="pl-5">
    ...
    echo ('
      <form action="./report.php" id="peakpro" class="fluid-container d-flex flex-column align-items-center justify-content-center p-5 mt-4">
        ...
        <button onclick="check()" class="mt-5 px-5 btn btn-lg btn-warning shadow-sm" type="submit" id="pro">
          Submit
        </button>
      </form>
    ');
      ...
      <form action="./report.php" id="peakpro" class="fluid-container d-flex flex-column align-items-center justify-content-center p-5 mt-4">
        <div class="p-4 shadow rounded w-50">
          ...
          <div class="pl-5">
            ...
            <div class="form-group">
            <input type="radio" name="protocol" value="incalphasmrptsd">
