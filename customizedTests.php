...
<body>
  ...
  if (!isset($_GET["band"]) || !isset($_GET["channel"])) {
    echo ('
    <form  action="./threshold.php" class="fluid-container d-flex flex-column align-items-center justify-content-center p-5 mt-4">
      ...
      <div class="channels py-4 pr-0 pl-4 shadow rounded w-50 mt-3">
        ...
        <div class="d-flex w-100 flex-wrap pl-5">
          <div class="form-group w-25">
            <input type="radio" value="1" name="channel"> <label>Channel 1</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="2" name="channel">
            <label>Channel 2</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="3" name="channel">
            <label>Channel 3</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="4" name="channel">
            <label>Channel 4</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="5" name="channel">
            <label>Channel 5</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="6" name="channel">
            <label>Channel 6</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="7" name="channel">
            <label>Channel 7</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="8" name="channel">
            <label>Channel 8</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="9" name="channel">
            <label>Channel 9</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="10" name="channel">
            <label>Channel 10</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="11" name="channel">
            <label>Channel 11</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="12" name="channel">
            <label>Channel 12</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="13" name="channel">
            <label>Channel 13</label>
          </div>
          <div class="form-group w-25">
            <input type="radio" value="14" name="channel">
